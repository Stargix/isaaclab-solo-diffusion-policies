...
from .rewards import TaskRewardWeights, average_speed_error, path_task_reward
...
class DPPODiffusionEnv(Solo12Env):
    ...
    def __init__(self, cfg: DPPODiffusionEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self._routes.reset(all_ids, cfg.route_stage, stratified=cfg.stratified_route_sampling)
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        success = (
            ...
            & (yaw_error.abs() <= self.cfg.terminal_yaw_tolerance_rad)
            & ((self._base_height() - state.target_height).abs() <= self.cfg.terminal_height_tolerance_m)
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        timeout_failure = self.reset_time_outs & ~self._success
        failed = (
        ...
        reward, terms = path_task_reward(
            ...
            mean_speed_error=self._last_mean_speed_error,
            yaw_error=yaw_error,
    ...
    def _reset_idx(self, env_ids: torch.Tensor | None):
        ...
        self._routes.reset(
            env_ids, self.cfg.route_stage, stratified=self.cfg.stratified_route_sampling
        )
