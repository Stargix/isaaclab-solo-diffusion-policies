"""Episode-level dataset splitting utilities.

Windows from the same rollout are strongly correlated.  Splitting window indices
at random leaks almost-identical samples into validation, so every split is made
on complete demonstrations before DataLoader construction.
"""
