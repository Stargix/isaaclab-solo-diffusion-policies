...
Example usage:
python scripts/diffusion_policy/data/inspect_dataset.py --dataset scripts/diffusion_policy/data/datasets/test_chained_raw.hdf5 --demo demo_0
"""
...
def main():
    ...
    if args.output_dir:
        ...
        # Default to scripts/diffusion_policy/data/plots/
