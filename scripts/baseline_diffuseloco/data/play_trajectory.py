...
Example usage:
python scripts/baseline_diffuseloco/data/play_trajectory.py --task="solo12-v0" --dataset scripts/baseline_diffuseloco/data/datasets/walk_raw.hdf5 --demo demo_0
"""
